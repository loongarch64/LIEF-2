...
const char* to_string(LOONGARCH_EFLAGS e) {
  CONST_MAP(LOONGARCH_EFLAGS, const char*, 6) enumStrings {
    { LOONGARCH_EFLAGS::EF_LARCH_BASE_ABI_ILP32S,   "BASE_ABI_ILP32S" },
    { LOONGARCH_EFLAGS::EF_LARCH_BASE_ABI_ILP32F,   "BASE_ABI_ILP32F" },
    { LOONGARCH_EFLAGS::EF_LARCH_BASE_ABI_ILP32D,   "BASE_ABI_ILP32D" },
    { LOONGARCH_EFLAGS::EF_LARCH_BASE_ABI_LP64S,    "BASE_ABI_LP64S" },
    { LOONGARCH_EFLAGS::EF_LARCH_BASE_ABI_LP64F,    "BASE_ABI_LP64F" },
    { LOONGARCH_EFLAGS::EF_LARCH_BASE_ABI_LP64D,    "BASE_ABI_LP64D" },
  };
