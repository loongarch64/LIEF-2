...
static const LOONGARCH_EFLAGS loongarch_eflags_array[] = {
  LOONGARCH_EFLAGS::EF_LARCH_BASE_ABI_ILP32S,
  LOONGARCH_EFLAGS::EF_LARCH_BASE_ABI_ILP32F,
  LOONGARCH_EFLAGS::EF_LARCH_BASE_ABI_ILP32D,
  LOONGARCH_EFLAGS::EF_LARCH_BASE_ABI_LP64S,
  LOONGARCH_EFLAGS::EF_LARCH_BASE_ABI_LP64F,
  LOONGARCH_EFLAGS::EF_LARCH_BASE_ABI_LP64D,
};
