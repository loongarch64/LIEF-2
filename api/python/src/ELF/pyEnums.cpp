...
void init_enums(py::module& m) {
  ...
  LIEF::enum_<LOONGARCH_EFLAGS>(m, "LOONGARCH_EFLAGS", py::arithmetic())
    .value(PY_ENUM(LOONGARCH_EFLAGS::EF_LARCH_BASE_ABI_ILP32S))
    .value(PY_ENUM(LOONGARCH_EFLAGS::EF_LARCH_BASE_ABI_ILP32F))
    .value(PY_ENUM(LOONGARCH_EFLAGS::EF_LARCH_BASE_ABI_ILP32D))
    .value(PY_ENUM(LOONGARCH_EFLAGS::EF_LARCH_BASE_ABI_LP64S))
    .value(PY_ENUM(LOONGARCH_EFLAGS::EF_LARCH_BASE_ABI_LP64F))
    .value(PY_ENUM(LOONGARCH_EFLAGS::EF_LARCH_BASE_ABI_LP64D));
